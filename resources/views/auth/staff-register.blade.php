<x-guest-layout>
    <form method="POST" action="{{ route('staff.register') }}">
        ...
        <div>
            ...
            <x-text-input id="StaffName" class="block mt-1 w-full" type="text" name="StaffName" :value="old('StaffName')"
        ...
        <div class="mt-4">
            ...
            <x-text-input id="StaffPW_confirmation" class="block mt-1 w-full" type="password"
    ...
    <div class="mt-4 text-center">
        <p>Not a staff? <a href="{{ route('player.register') }}" class="text-indigo-600">Switch to Player
